...
class OLD_LocationServiceForeground : Service() {
    ...
    private fun generateNotification(location: Location?): Notification {
        ...
        // 0. Get data
        val mainNotificationText = location?.toText() ?: getString(R.string.no_location_text) // String definition found in: res/values/strings.xml
...
//            )
    ...
    companion object {
        private const val TAG = "LocationServiceForeground"
