...
class OLD_LocationFragment : Fragment(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private var locationServiceForeground: OLD_LocationServiceForeground? = null
    ...
    private val foregroundOnlyServiceConnection = object : ServiceConnection {
        ...
        override fun onServiceConnected(name: ComponentName, service: IBinder) {
            val binder = service as OLD_LocationServiceForeground.LocalBinder
    ...
    override fun onStart() {
        ...
        val serviceIntent = Intent(requireContext(), OLD_LocationServiceForeground::class.java)
    ...
    override fun onResume() {
        ...
        LocalBroadcastManager.getInstance(requireContext()).registerReceiver(
            ...
            IntentFilter(
                OLD_LocationServiceForeground.ACTION_FOREGROUND_ONLY_LOCATION_BROADCAST)
        )
    }
    ...
    /**
     * Receiver for location broadcasts from [OLD_LocationServiceForeground].
     */
    private inner class ForegroundOnlyBroadcastReceiver : BroadcastReceiver() {

        override fun onReceive(context: Context, intent: Intent) {
            val location = intent.getParcelableExtra<Location>(
                OLD_LocationServiceForeground.EXTRA_LOCATION
            )
